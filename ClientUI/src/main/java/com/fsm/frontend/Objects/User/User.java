...
import com.fsm.frontend.Interfaces.MyObject;
...
public class User {
    ...
    public User setPort(int portNum) {
        this.portNum = portNum;
        return this;
    }

    public void buy(Valuable valuable, int lastPrice) {
        //TODO SEND ITEM SOLD EVENT
        //TODO SET ITEM STATUS TO SOLD
        //TODO CHECK IF THIS USER IS THE WINNER
        //OTHERWISE HE CANNOT BUY THE ITEM
